    ...
    <!--<div class="fillcontain">-->
        <!--<div class="table_container">-->
            ...
            <!--<el-row style="display:flex;margin-bottom: 30px;">-->
                <!--&lt;!&ndash;<el-button style='' type="primary" icon="document" @click="handleDownload" :loading="downloadLoading"> 导出excel</el-button></el-col>&ndash;&gt;-->
            ...
            <!--</div>-->
        <!--</div>-->
        <!--&lt;!&ndash;<el-dialog title="异常记录" :visible.sync="dialogTableVisible" width="1000px">&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<div style="margin-bottom: 10px">用户：{{userNickName}}</div>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<div style="display:inline-block">&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<div style="display: inline-block">&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<span style="font-size: 14px;width:80px;">类型：</span>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<el-select v-model="state" placeholder="请选择" @change="changeIAType">&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<el-option&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;v-for="item in options"&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;:key="item.label"&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;:label="item.label"&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;:value="item.label">&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;</el-option>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;</el-select>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<div style="display: inline-block">&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<span style="font-size: 14px;width:80px;">时间：</span>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<el-date-picker&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;style="width:200px"&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;v-model="startDate"&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;type="datetimerange"&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;align="right"&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;:default-time="['12:00:00', '08:00:00']">&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;</el-date-picker>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;<el-button type="primary" @click="serchByTime">搜索</el-button>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;&lt;!&ndash;</div>&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;<el-table :data="tableData">&ndash;&gt;-->
                <!--&lt;!&ndash;<el-table-column property="time" label="日期"></el-table-column>&ndash;&gt;-->
                <!--&lt;!&ndash;<el-table-column property="amount" label="获取或提取IA"></el-table-column>&ndash;&gt;-->
                <!--&lt;!&ndash;<el-table-column property="detail" label="行为"></el-table-column>&ndash;&gt;-->
                <!--&lt;!&ndash;<el-table-column property="aboutUsers" label="有关用户"></el-table-column>&ndash;&gt;-->
            <!--&lt;!&ndash;</el-table>&ndash;&gt;-->
            <!--&lt;!&ndash;<div class="Pagination">&ndash;&gt;-->
                <!--&lt;!&ndash;<el-pagination&ndash;&gt;-->
                    <!--&lt;!&ndash;@size-change="handleDetailSizeChange"&ndash;&gt;-->
                    <!--&lt;!&ndash;@current-change="handleDetailCurrentChange"&ndash;&gt;-->
                    <!--&lt;!&ndash;:current-page="currentPageDetail"&ndash;&gt;-->
                    <!--&lt;!&ndash;:page-size="nowPageSizeDetail"&ndash;&gt;-->
                    <!--&lt;!&ndash;:page-sizes="[5, 10, 20, 40]"&ndash;&gt;-->
                    <!--&lt;!&ndash;:total="txcountDetail"&ndash;&gt;-->
                    <!--&lt;!&ndash;layout="total, sizes, prev, pager, next, jumper"&ndash;&gt;-->
                <!--&lt;!&ndash;&gt;&ndash;&gt;-->
                <!--&lt;!&ndash;</el-pagination>&ndash;&gt;-->
            <!--&lt;!&ndash;</div>&ndash;&gt;-->
        <!--&lt;!&ndash;</el-dialog>&ndash;&gt;-->
        <!--&lt;!&ndash;<el-dialog title="" :visible.sync="dialogFormVisible">&ndash;&gt;-->
            <!--&lt;!&ndash;<el-form :model="form">&ndash;&gt;-->
                <!--&lt;!&ndash;<el-form-item label="审核结果：" :label-width="formLabelWidth">&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-radio-group v-model="result">&ndash;&gt;-->
                        <!--&lt;!&ndash;<el-radio :label="3">黑名单</el-radio>&ndash;&gt;-->
                        <!--&lt;!&ndash;<el-radio :label="6">白名单</el-radio>&ndash;&gt;-->
                        <!--&lt;!&ndash;<el-radio :label="9">待定</el-radio>&ndash;&gt;-->
                    <!--&lt;!&ndash;</el-radio-group>&ndash;&gt;-->
                <!--&lt;!&ndash;</el-form-item>&ndash;&gt;-->
                <!--&lt;!&ndash;<el-form-item label="备注：" :label-width="formLabelWidth">&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-input type="textarea" v-model="remarks"></el-input>&ndash;&gt;-->
                <!--&lt;!&ndash;</el-form-item>&ndash;&gt;-->
            <!--&lt;!&ndash;</el-form>&ndash;&gt;-->
