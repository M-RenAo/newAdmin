    ...
    <div class="manage_page fillcontain">
        <el-container style="height: 100%;">
            <el-aside width="200px" style="min-height: 100%; background-color: #324057;">
                <div class=""
                     style="height: 56px;line-height: 56px;color:#edf7ff;position: fixed;z-index:100;width:200px;background-color: #324057;text-align:center">
                    <span style="color:#409EFF;font-style:italic;font-size: 20px">imApp</span> 管理平台
                </div>
                <el-menu :default-active="defaultActive" style="min-height: 90%;border:0;margin-top: 56px;"
                    ...
                    <el-submenu index="'5c'">
                        ...
                        <el-submenu index="5-1" v-if="adminType=='VISITOR'">
                        ...
                        <el-menu-item index="deploy" v-if="adminType!='VISITOR'">运营部署</el-menu-item>
