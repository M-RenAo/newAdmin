            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template scope="scope">
                        <img :src="'https://imapp-image.oss-cn-hangzhou.aliyuncs.com/'+scope.row.headPic" style="width:30px;height:30px;" v-if="scope.row.headPic!=undefined">
                    </template>
                </el-table-column>
                <el-table-column
                    label="昵称"
                    min-width="50">
                    <template scope="scope">
                        <router-link :to="{path:'/userInfo',query:{id:scope.row.userId}}">{{scope.row.userNickName}}</router-link>
                    </template>
                </el-table-column>
                <el-table-column
                    prop="userPhone"
                ...
                <el-table-column
                    ...
                    min-width="100">
                    <template scope="scope">
                        <el-button  type="text" @click="checkIA(scope.row.userId,scope.row.userNickName)">IA明细</el-button>
                        <el-button  type="text" @click="checkBCD(scope.row.userId,scope.row.userNickName)" style="margin-left:0">BCD明细</el-button>
        ...
        data(){
            return {
                ...
                options:[
                    ...
                    {label:'兑换BCD',value:'3'},{label:'提取BCD',value:'3'},{label:'安装挖矿',value:'4'}, {label:'打开挖矿',value:'5'},
        ...
        methods: {
            getData() {
                this.$ajax({
                    ...
                    params:{pageCode:this.currentPage, pageSize: this.nowPageSize,num:this.num,order:this.sortRule.toString()+this.desc.toString()},
            ...
            handleIASizeChange(pageSize){
                ...
                if(this.startDate===null){
                    this.getIADetail({userId:this.userId,pageCode:1,pageSize:this.nowPageSizeIA,type:1,startTime:'',endTime:'',txType:this.state=='全部'?null:this.state})
                }else{
                    this.getIADetail({userId:this.userId,pageCode:1,pageSize:this.nowPageSizeIA,type:1,startTime:moment(this.startDate[0]).utc().format('YYYY-MM-DD HH:mm:ss'),endTime: moment(this.startDate[1]).utc().format('YYYY-MM-DD HH:mm:ss'),txType:this.state=='全部'?null:this.state})
                }
            },
            handleIACurrentChange(pageValue){
                this.currentPageIA = pageValue;
                if(this.startDate===null){
                    this.getIADetail({userId:this.userId,pageCode:this.currentPageIA,pageSize:this.nowPageSizeIA,type:1,startTime:'',endTime:'',txType:this.state=='全部'?null:this.state})
                }else{
            ...
            changeIAType(){
                ...
                if(this.startDate===null){
                   ...
                   this.getIADetail({userId:this.userId,pageCode:1,pageSize:10,type:1,startTime:moment(this.startDate[0]).utc().format('YYYY-MM-DD HH:mm:ss'),endTime:moment(this.startDate[1]).utc().format('YYYY-MM-DD HH:mm:ss'),txType:this.state=='全部'?null:this.state})
                }
            },
            checkBCD(id,name){
                this.userNickName=name
            ...
            handleBCDSizeChange(pageSize){
                this.nowPageSizeIA = pageSize;
                if(this.startDate===null){
                    this.getIADetail({userId:this.userId,pageCode:1,pageSize:this.nowPageSizeIA,type:0,startTime:'',endTime:'',txType:this.state=='全部'?null:this.state})
                }else{
                    this.getIADetail({userId:this.userId,pageCode:1,pageSize:this.nowPageSizeIA,type:0,startTime:moment(this.startDate[0]).utc().format('YYYY-MM-DD HH:mm:ss'),endTime: moment(this.startDate[1]).utc().format('YYYY-MM-DD HH:mm:ss'),txType:this.state=='全部'?null:this.state})
                }
            },
            handleBCDCurrentChange(pageValue){
                this.currentPageIA = pageValue;
                if(this.startDate===null){
                    this.getIADetail({userId:this.userId,pageCode:this.currentPageIA,pageSize:this.nowPageSizeIA,type:0,startTime:'',endTime:'',txType:this.state=='全部'?null:this.state})
                }else{
            ...
            changeBCDType(){
                ...
                if(this.startDate===null){
                    ...
                    this.getIADetail({userId:this.userId,pageCode:1,pageSize:10,type:0,startTime:moment(this.startDate[0]).utc().format('YYYY-MM-DD HH:mm:ss'),endTime:moment(this.startDate[1]).utc().format('YYYY-MM-DD HH:mm:ss'),txType:this.state=='全部'?null:this.state})
                }
            },
            // checkInvite(id,name){
            //     this.userNickName=name
