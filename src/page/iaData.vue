                        ...
                        <el-form  class="form food_form">
                            <div>
                                <el-form-item label="修改IA总资产账户密码：">
                                    <el-button type="primary" style="margin-right:10px;margin-bottom:2px;" @click="modifyPass">修改账户密码
                                    </el-button>
                                </el-form-item>
                                <el-form-item label="转账至竞猜账户：" >
                                </el-form-item>
                                <el-form-item label="转账金额：" >
                                    <el-input type="number" style="width:200px" min="1" v-model="money"></el-input> IA
                                </el-form-item>
                                <el-form-item>
                                <el-button type="primary" style="margin-right:10px;margin-bottom:2px;" @click="transfer(money)">转账
                                </el-button>
                                </el-form-item>
                            </div>
                        </el-form>
        ...
        created() {
            this.$ajax({
               ...
               this.ctime=moment.utc(response.data.data.ctime).local().format('YYYY-MM-DD HH:mm:ss')
                ...
                const form = {appId: '2341a6e2c53d4ed182bd35bee0ddce84',pageCode: this.currentPage, pageSize: this.nowPageSize}
                this.getData(form)
        },
        computed: {},
        methods: {
