    ...
    <div>
        <div class="table_container">
            <div style="display: flex;font-size: 14px;margin-bottom: 20px">
                <div class="card-data">
                    ...
                    <p>总发放人数：{{beInviteAndRegiNum}}</p>
                    <p>总人均发放：{{beInviteAndRegiNum}}</p>
                </div>
                <div class="card-data">
                    ...
                    <p>总是用卡全数：{{inviteSign}}</p>
                    <p>总人均使用数：{{inviteSign}}</p>
                </div>
                <div class="card-data">
                    ...
                    <p>已经过期卡全数：{{beInviteAndAuthNum}}</p>
                </div>
                <!--<div class="card-data">-->
            ...
            <el-table
                ...
                >
                    <template scope="scope">
                        <el-button type="text" @click="checkDetail(scope.row.title)">卡券明细</el-button>
                    </template>
                </el-table-column>
                <!--<el-table-column-->
                <!--label="注册用户"-->
        ...
        <el-dialog  :visible.sync="dialogIaCardVisible" width="1000px">
            ...
            <el-table :data="iaCardData">
                ...
                <el-table-column property="address" label="实际翻倍奖励"></el-table-column>
            </el-table>
